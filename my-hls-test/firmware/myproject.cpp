...
void myproject(
    ...
    #pragma HLS INTERFACE ap_vld port=input_1,layer12_out 
    #pragma HLS DATAFLOW 
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<model_default_t, 25600>(w9, "w9.txt");
        nnet::load_weights_from_txt<model_default_t, 64>(b9, "b9.txt");
        nnet::load_weights_from_txt<model_default_t, 640>(w11, "w11.txt");
    ...
    nnet::softmax<layer11_t, result_t, softmax_config12>(layer11_out, layer12_out); // dense_1_softmax
